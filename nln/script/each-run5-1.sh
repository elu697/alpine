...
(ssh icnl_lrd_vm7 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data5")&
(ssh icnl_lrd_vm6 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data4")&
