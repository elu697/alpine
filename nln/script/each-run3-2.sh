...
(ssh icnl_lrd_vm14 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data9")&
(ssh icnl_lrd_vm13 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data8")&
(ssh icnl_lrd_vm12 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data7")&
...
(ssh icnl_lrd_vm9 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data4")&
(ssh icnl_lrd_vm8 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data3")&
(ssh icnl_lrd_vm7 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data2")&
