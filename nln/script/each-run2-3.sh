...
(ssh icnl_lrd_vm16 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data8")&
(ssh icnl_lrd_vm15 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data7")&
(ssh icnl_lrd_vm14 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data6")&
(ssh icnl_lrd_vm13 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data5")&
(ssh icnl_lrd_vm12 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data4")&
(ssh icnl_lrd_vm11 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data3")&
(ssh icnl_lrd_vm10 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data2")&
(ssh icnl_lrd_vm9 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data1")&
sleep 1
