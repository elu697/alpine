...
(ssh icnl_lrd_vm6 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data3")&
(ssh icnl_lrd_vm5 "cd /home/docker/alpine/nln && bash run.sh router2 /model/A /data4")&
sleep 1
